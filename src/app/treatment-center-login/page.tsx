...
export default function TreatmentCenterLoginPage() {
  ...
  useEffect(() => {
    if (!isUserLoading && user) {
      // Redirect to treatment center portal
      router.replace('/treatment-center');
    }
    ...
    <Card className="w-full max-w-sm">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl">
          {isLoginView ? 'Treatment Center Portal' : 'Register Treatment Center'}
        </CardTitle>
        <CardDescription>
          {isLoginView
            ? 'Access your client management dashboard.'
            : 'Sign up to access the treatment center portal.'}
        </CardDescription>
      </CardHeader>
      <CardContent>
